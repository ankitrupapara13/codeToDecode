...
<body>
    ...
    <div style="margin-top: 7%;" class="container">
        ...
        <div>
         <p><b>Invoice ID: <%= inv.getInvoiceId()%></b> </p>
        <p><b>Invoice Date: <%=inv.getInvoiceDate() %></b></p>
        <p><b>Customer ID: <%=inv.getCustomerId() %></b></p>
        <p><b>Order ID: <%=inv.getOrderId() %></b></p>
        <p><b>GST Type: <%=gstType %></b></p>
        <p><b>GST Amount: <%=inv.getGstAmount() %></b></p>
        <p><b>Total Invoice Amount: <%=inv.getTotalInvoiceAmount() %></b></p>
        <p><b>Payment Status: <%=inv.isStatus() %></b></p>
        <br>
        </div>
