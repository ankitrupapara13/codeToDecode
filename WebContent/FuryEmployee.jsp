...
<%
    ...
    <nav class="navbar navbar-dark bg-dark">
     ...
     <div class="login-box">
        ...
        <form action="./employeeLogin" class="employeeLoginForm" method = "POST">
        
        <div class="textbox">
               	
            <label for ="Username"></label>
            <input type="number" placeholder="Username" id="employeeId" name="employeeId" required>
            </div>
            <div class="textbox">
           ...
           <div>
            <input class="employeebutton" type="submit" value="Log In" onclick="login()">
            </div>
