...
<link rel="stylesheet" href="css/FuryCustomer.css" />
</head>
...
<body>
	...
	<nav class="navbar navbar-dark bg-dark">
		<a class="navbar-brand" href="#"><img src="images/LogoRounded.jpg"
							...
							<div class="login-box">
								...
								<form action="./customerLogin" method="POST"
									...
									<div class="form-group" class="textbox">
										<label for="customerId"></label> <input type="number"
											class="form-control" id="customerId" name="customerId"
											aria-describedby="emailHelp" placeholder="CustomerId"
											required>
									</div>
									<div class="form-group" class="textbox">
									...
									<div class="form-group">
										<input type="submit" class="customerbutton" value="Log-in">
									</div>

								</form>
								<label id="loginMessage" style="color: black"></label>
							</div>
						</div>
					</div>
				</div>
